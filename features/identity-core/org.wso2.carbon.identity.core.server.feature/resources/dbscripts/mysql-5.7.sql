...
CREATE TABLE IDN_RF_CONFIG (
	ID INT NOT NULL AUTO_INCREMENT,
	TENANT_ID INT NOT NULL,
	USER_NAME VARCHAR(255) NOT NULL,
	REPO_CONNECTOR_TYPE VARCHAR(255) NOT NULL,
	ACTION_LISTENER_TYPE VARCHAR(255) NOT NULL,
	CONFIG_DEPLOYER_TYPE VARCHAR(255) NOT NULL,
	ATTRIBUTES_JSON MEDIUMTEXT NOT NULL,
	PRIMARY KEY (ID),
	CONSTRAINT UC_CONFIG UNIQUE (REPO_CONNECTOR_TYPE,CONFIG_DEPLOYER_TYPE,TENANT_ID)
)ENGINE INNODB;

CREATE TABLE IDN_RF_REVISIONS (
	ID INT NOT NULL AUTO_INCREMENT,
	...
	PRIMARY KEY (ID),
	FOREIGN KEY (CONFIG_ID) REFERENCES IDN_RF_CONFIG(ID),
